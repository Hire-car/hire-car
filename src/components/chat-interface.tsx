    ...
    <div className="flex flex-col h-[600px] max-h-[80vh] rounded-lg border border-slate-200 bg-white shadow-sm overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-slate-50/50">
        ...
        <div className="flex justify-center mb-6">
          <div className="bg-[#FEF9C3] text-[#854D0E] text-[11px] px-4 py-2 rounded-xl text-center max-w-sm flex items-center justify-center gap-2 shadow-sm border border-[#FEF08A]/50 font-medium">
